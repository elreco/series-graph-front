        ...
        <CardContent className="space-y-8 px-6 pb-8 sm:px-8">
          <section className="space-y-3">
            ...
            <p className="leading-relaxed text-muted-foreground">
              At Watch Peak, we believe you should have control over your personal information. This document explains the privacy choices available to you and how to exercise your rights.
            </p>
          </section>
          <Separator />
          <section className="space-y-4">
            ...
            <div className="space-y-6">
              <div className="space-y-3">
                ...
                <div className="space-y-3">
                  ...
                  <ul className="ml-6 list-disc space-y-1 text-muted-foreground">
                    ...
                    <li>Control what information is shared with Watch Peak</li>
                  </ul>
              ...
              <Separator />
              <div className="space-y-3">
                <h3 className="text-xl font-semibold">2. Contact</h3>
                <p className="text-muted-foreground">For any privacy-related questions:</p>
          ...
          <section className="rounded-lg bg-muted/50 p-4">
            <p className="text-sm italic text-muted-foreground">
              By using Watch Peak, you acknowledge that you have read and understood your privacy choices and how to exercise them.
            </p>
          </section>
        </CardContent>
      </Card>
